    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-12 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 animate-slide-down opacity-0" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
            <span className="chip bg-accent/10 text-accent">Social Entrepreneur</span>
          </div>
          
          <h1 className="font-semibold tracking-tight leading-tight mb-6 animate-slide-down opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            Creating Lasting Change <br />Through Social Innovation
          </h1>
          
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-slide-down opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
            Building bridges between social impact and entrepreneurship. Transforming communities through sustainable business models.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-slide-down opacity-0" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
        ...
        {/* Stats Section */}
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto animate-slide-down opacity-0" style={{ animationDelay: '0.9s', animationFillMode: 'forwards' }}>
